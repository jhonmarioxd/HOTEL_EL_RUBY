...
<body class="scroll-bar">
    ...
    <div class="content">
        ...
        <form method="post" action="">
            <table class="room-table">
                <caption>Control de Habitaciones</caption>
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Habitación</th>
    ...
    <div class="toggle-button">
        ...
        <span id="toggle-label">Página Activa</span>
    </div>
    <!-- Agregar un botón para volver a la página de inicio -->
    <div class="content">
        <a href="index.php" class="btn btn-fill">Volver a la Página de Inicio</a>
    </div>
    <!--bottom bar-->
    <footer class="footer">
...
<?php
    ...
    // Si el usuario no ha iniciado sesión, redirige a la página de inicio de sesión u otra página
