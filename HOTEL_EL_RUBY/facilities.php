                ...
                <div class="row center-lg">
                    <div class="col image-col right-marg">
                        <div class="large-image-container">
                            <img src="..//imgenes/logo/5a452570546ddca7e1fcbc7d (1).png" alt="room-image-large" class="large-image">
                        </div>
                ...
                <div class="containera">
                    ...
                    <div class="gallery">
                        ...
                        <div class="gallery-item">
                            <img width="500px" height="250px" class="gallery-image" src="..//imgenes/logo/269814251_330044932455619_6132515414850091291_n.jpg" alt="restaurants">
                            <h2>Restaurante</h2>
                            <p class="imggrid">
                        ...
                        <div class="gallery-item">
                            <img width="500px" height="250px" class="gallery-image" src="../imgenes/habitaciones e instalaciones/263599402_320101160116663_8865088752819283339_n.jpg" alt="restaurants">
                            <h2>Piscina</h2>
                            <p class="imggrid">
