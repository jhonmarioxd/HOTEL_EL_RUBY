        ...
        <div class="header-container">
            <nav class="header-nav-bar">
                <div class="header-nav-logo">
                    <a href="index.php">
                        <img width="300px" src="../imgenes/logo/logo del hotel.png" alt="Hotel El Ruby">
                    </a>
                </div>
                <ul class="header-nav-lists">
                    ...
                    <li class="header-nav-list">
                        <a href="login.php">
                            <img style="width: auto; height: 40px; padding-bottom: 10px;" src="assets/img/1077114.png" alt="Iniciar sesión y registrarse">
                        </a>
                    </li>
    ...
    <section class="special-offers">
        ...
        <div class="row center-lg">
            <div class="col image-col right-marg">
                <img src="../imgenes/habitaciones e instalaciones/269906225_332747272185385_2903575361492489064_n.jpg" alt="room-image" class="small-image">
                <img src="../imgenes/habitaciones e instalaciones/20031690_1991793217721671_3559146115283967244_n.jpg" alt="room-image" class="small-image">
                <img src="../imgenes/habitaciones e instalaciones/263599402_320101160116663_8865088752819283339_n.jpg" alt="room-image" class="small-image img-hide">
                <div class="side-by-side-container">
                    <div class="large-image-container">
                        <img src="../imgenes/habitaciones e instalaciones/59870784_2397914190442903_6242255302788382720_n.jpg" alt="room-image-large" class="large-image">
                    </div>
                    <section class="stacked-image-container">
                        <div><img src="../imgenes/habitaciones e instalaciones/285496298_446120470848064_2195770567369364133_n.jpg" alt="room-image" class="small-image"></div>
                        <div><img src="..//imgenes/habitaciones e instalaciones/269814251_330044932455619_6132515414850091291_n.jpg" alt="room-image" class="small-image"></div>
                    </section>
                </div>
            </div>
            <div class="col">
                ...
                <a href="../HOTEL_EL_RUBY/reservar.php" class="btn btn-fill btn-large centered">Reservar ahora</a>
            </div>
        </div>
    </section>
    <!-- Bottom bar -->
