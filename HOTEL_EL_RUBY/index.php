    ...
    <div class="jumbotron-container">
        ...
        <div class="jumbotron-right">
            <form method="post" action="./bd/consultar_tarifa.php" class="jumbotron-form">
                ...
                <label class="hide" for="arrival">Fecha de llegada</label>
                <input type="text" id="arrival" name="Fecha de llegada" placeholder="Fecha de llegada" onfocus="(this.type='date')"><br>
                <label class="hide" for="departure">Fecha de salida</label>
